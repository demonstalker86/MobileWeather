...
class TestApp(App):
    ...
    def build(self):
        ...
        self.button1 = Button(text=weather_info1, font_size=30)
        self.button2 = Label(text=weather_info2, font_size=30)
        self.button3 = Button(text=weather_info3, font_size=30)
        self.button4 = Button(text='ПОКАЗАТЬ', font_size=30)
